...
* add support for MediaFire, CapCut, and SnackVideo platforms with corresponding downloader implementations and update documentation ([6ac1ac1](https://github.com/EngDawood/download-media/commit/6ac1ac1572e56be08dbbfac9e54a951c39d926a0))
...
* block X posts flagged sensitive for guests ([#35](https://github.com/EngDawood/download-media/issues/35)) ([0dfbba7](https://github.com/EngDawood/download-media/commit/0dfbba78d91ea572a27baf98389dfe2d89df7b14))
...
* **docs:** add SKILL.md and direct-downloaders.md for download-media MCP tools usage and fallback methods ([85350b8](https://github.com/EngDawood/download-media/commit/85350b81c5c493eb17a7ec895ddec3faf34ad74f))
...
* enhance reply functionality for admin messages and update translations ([0adbb3c](https://github.com/EngDawood/download-media/commit/0adbb3ca48a5357998fed51610f0d8d3b985c671))
...
* **facebook:** offer an "Other quality" button after the send ([9bb8556](https://github.com/EngDawood/download-media/commit/9bb8556322c5dfa1424ac443ba2e12d864d99261))
* **facebook:** offer an "Other quality" button after the send ([d4b1382](https://github.com/EngDawood/download-media/commit/d4b138267612a18a74655060cb656ac07b99656b))
* **facebook:** try fdown extractor ahead of AIO ([9d6b0a2](https://github.com/EngDawood/download-media/commit/9d6b0a2f9ed7f354dcfcf351fbc4e570da89d338))
* **facebook:** try fdown extractor ahead of AIO ([a9dd511](https://github.com/EngDawood/download-media/commit/a9dd51156e484bddb1b4b3661ba40f6cae0bced1))
* **google-drive:** add PDF export option for Google Docs/Slides and implement related tests ([aaf9566](https://github.com/EngDawood/download-media/commit/aaf95662bc4be3a12b50931b80012c62ec172c45))
* **google-drive:** implement Google Drive provider for media downloads and add related tests ([d59746d](https://github.com/EngDawood/download-media/commit/d59746d2b79c86caddace15b885cb979d67434d0))
