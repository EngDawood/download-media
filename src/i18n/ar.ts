...
export const ar: Translations = {
	...
	'download.delay_retry':
		'⏳ العملية استغرقت وقتاً أطول من المعتاد وانتهت مهلة التحميل.\n\nرابطك سليم — التأخير من خوادم التحميل وليس منك.\n<code>{url}</code>\n<i>اضغط 🔄 إعادة المحاولة — غالباً ما ينجح في المحاولة الثانية.</i>',
	'download.busy_retry':
	...
	'download.file_name': '📄 <b>الاسم:</b> {name}',
	'download.file_size': '📦 <b>الحجم:</b> {size}',
	'download.file_type': '🎞 <b>النوع:</b> {type}',
	'download.type_video': 'فيديو',
	'download.type_audio': 'صوت',
